...
namespace Util
{
    public class Rect
    {
...
#if UTILS_XAMARIN_ENABLED
        public  Xamarin.Forms.Rectangle Xamarin.Forms.Rectangle
        {
        ...
        public Xamarin.Forms.Rectangle GetRectangle()
        {
            return new Xamarin.Forms.Rectangle(_x, _y, _width, _height);
        }
#endif
